...
Category `balances`, Monitor `balances`, and Statement `startingBalances`/`endingBalances` are omitted
until their calculations are implemented. These responses do not report fabricated zero balances.
