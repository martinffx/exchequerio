...
ALTER TABLE "ledger_account_balance_monitors" ADD COLUMN "organization_id" text NOT NULL;--> statement-breakpoint
ALTER TABLE "ledger_account_balance_monitors" ADD COLUMN "ledger_id" text NOT NULL;--> statement-breakpoint
